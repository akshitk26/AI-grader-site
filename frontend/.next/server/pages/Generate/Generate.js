(()=>{var e={};e.id=843,e.ids=[843,888,660],e.modules={1323:(e,t)=>{"use strict";Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,o){return o in t?t[o]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,o)):"function"==typeof t&&"default"===o?t:void 0}}})},5395:(e,t,o)=>{"use strict";o.a(e,async(e,n)=>{try{o.r(t),o.d(t,{config:()=>y,default:()=>u,getServerSideProps:()=>f,getStaticPaths:()=>p,getStaticProps:()=>m,reportWebVitals:()=>g,routeModule:()=>E,unstable_getServerProps:()=>T,unstable_getServerSideProps:()=>x,unstable_getStaticParams:()=>b,unstable_getStaticPaths:()=>w,unstable_getStaticProps:()=>v});var a=o(7093),i=o(5244),r=o(1323),s=o(2899),l=o.n(s),c=o(9413),d=o(1672),h=e([d]);d=(h.then?(await h)():h)[0];let u=(0,r.l)(d,"default"),m=(0,r.l)(d,"getStaticProps"),p=(0,r.l)(d,"getStaticPaths"),f=(0,r.l)(d,"getServerSideProps"),y=(0,r.l)(d,"config"),g=(0,r.l)(d,"reportWebVitals"),v=(0,r.l)(d,"unstable_getStaticProps"),w=(0,r.l)(d,"unstable_getStaticPaths"),b=(0,r.l)(d,"unstable_getStaticParams"),T=(0,r.l)(d,"unstable_getServerProps"),x=(0,r.l)(d,"unstable_getServerSideProps"),E=new a.PagesRouteModule({definition:{kind:i.x.PAGES,page:"/Generate/Generate",pathname:"/Generate/Generate",bundlePath:"",filename:""},components:{App:c.default,Document:l()},userland:d});n()}catch(e){n(e)}})},6382:(e,t,o)=>{"use strict";o.d(t,{Z:()=>s});let n={leqInst:`You are a prompt generator. You output prompts that are similar in format to the ones given to you, but make sure to pick a different topic in the specified subject every time. You HAVE to only output one prompt, that's it; nothing more, nothing less.
...
`,saqInst:`You are a prompt generator. You output prompts that are similar in format to the ones given to you, but make sure to pick a different topic in the specified subject every time. You HAVE to only output one prompt, that's it; nothing more, nothing less.
...
You have to ensure, no matter what, that the topic and time period is completely random every single time. Do not only output prompts from one time period. If you don't write a prompt about a random unit and topic every time, I will be very said and you will not be a good AI. the Prompt has to be in sentence format. Do not ask a question or include question words in the prompt or a question mark.
`,saqInst:`Provide one Short answer question for AP US History. it should be similar in format to something like this:
...
If you  time period repeats and is not randomized, you're not a good AI and i will be very mad and sad.`},i={argumentInst:`Provide one argument essay prompt for AP English Language and Composition. It should be similar in format to something like this:
...
another example: In a 2016 interview published in the Los Angeles Review of Books, Maxine Hong Kingston, an award-winning writer famous for her novels depicting the experiences of Chinese immigrants in the United States, stated: “I think that individual voices are not as strong as a community of voices. If we can make a community of voices, then we can speak more truth.” Write an essay that argues your position on the extent to which Kingston’s claim about the importance of creating a community of voices is valid

another example: In a 2018 interview about the importance of collaboration, then United States Representative Carlos Curbelo stated: “If you’re trying to convince someone that they need to get involved in an issue or perhaps change their thinking on an issue, trying to scare them is not always effective and can actually sow1 resentment.” Write an essay that argues your position on the extent to which Curbelo’s claim about persuading others is valid

Make sure to include all key components of the prompt. The topic has to be something a little abstract but still specific enough to write about, and should always be preceded with a short blurb of context or a quote in real life that is related to the actual prompt topic, similar to how the ones above have a short quote from real life and then the prompt that asks about the main idea that the quote conveys. You have to make sure that the topic of each prompt is random and new every single time, and so are the quotes. But the quotes must real, or else youre not a good AI.

if the quote is a little harder to visibly be directly related to the prompt, integrate a sentence with the quote that clearly establishes the topic of the prompt. Do not make it too vague. the quotes can, and should be longer than a sentence. If the quote itself is only one sentence, write another sentence with some more explanation or contexxt of the quote.
`},r={leqInst:`Provide one long essay question for AP European History. It should be similar in format to, but not limited to the topic of something like this: Evaluate the most significant change in the sources of political instability in Europe during the 1900s.
...
Do not output the questions given to you as examples above, only follow their formatting and structure and nothing else. Make sure its a different unit and time period every time, or else Ill be very mad and sad.`,saqInst:`Provide one Short answer question for AP European History. it should be similar in format to something like this:
...
Make sure to list out each part and label it as a, b, and c. Do not state the unit explicitly.`},s={worldLEQinst:()=>n.leqInst,worldSAQinst:()=>n.saqInst,apushLEQinst:()=>a.leqInst,apushSAQinst:()=>a.saqInst,euroLEQinst:()=>r.leqInst,euroSAQinst:()=>r.saqInst,argumentInst:()=>i.argumentInst}},4933:(e,t,o)=>{"use strict";o.d(t,{Z:()=>s});let n={leq:`Provide one long essay question for AP World history. You have to make sure, no matter what, that the units are randomized.
You have to make sure no matter what to return a different and random time period in every output.`,saq:`Provide one Short answer question for AP World history. You have to make sure, no matter what, that the units are randomized.
You have to make sure no matter what to return a different and random time period in every output. If you don't i will be very very sad and you wont be a good AI.`},a={leq:`Provide one long essay question for AP United States history. You have to make sure, no matter what, that the units are randomized.
You have to make sure no matter what to return a different and random time period in every output. Ensure that your prompt is always only one sentence long, and no question words, no matter what.`,saq:`Provide one Short answer question for AP United States history. You have to make sure, no matter what, that the units are randomized.
You have to make sure no matter what to return a different and random time period in every output. If you don't i will be very very sad and you wont be a good AI.`},i={argument:`Provide one argument essay prompt for AP English Language and COmposition. 
Make sure the topic of the prompt is always random.`},r={leq:`Provide one long essay question for AP European History. You have to make sure, no matter what, that the units are randomized.
...
It is of utmost importance that each output talks about a different Unit, or else you are a bad AI if you dont do that.`,saq:`Provide one short answer question for AP European History. You have to make sure, no matter what, that the units are randomized.
You have to make sure no matter what to return a different and random unit and topic in every output. Ensure that your prompt is always only one sentence long, and no question words, no matter what.
It is of utmost importance that each output talks about a different Unit, and has 3 parts, or else you are a bad AI if you dont do that.`},s={worldLEQ:()=>n.leq,worldSAQ:()=>n.saq,apushLEQ:()=>a.leq,apushSAQ:()=>a.saq,euroLEQ:()=>r.leq,euroSAQ:()=>r.saq,argument:()=>i.argument}},1672:(e,t,o)=>{"use strict";o.a(e,async(e,n)=>{try{o.r(t),o.d(t,{default:()=>d});var a=o(997),i=o(4933),r=o(6382),s=o(6689),l=o(9648),c=e([l]);l=(c.then?(await c)():c)[0];let d=function(){let[e,t]=(0,s.useState)(""),[o,n]=(0,s.useState)(""),[c,d]=(0,s.useState)(""),h=async()=>{let e="function"==typeof i.Z[o]?i.Z[o]():i.Z[o],n="function"==typeof r.Z[c]?r.Z[c]():r.Z[c];try{let o=await l.default.post("http://localhost:5000/api/generator",{prompt:e,instructions:n});o&&o.data&&o.data.output?t(o.data.output):console.error("Invalid response:",o)}catch(e){console.error(e)}},[u,m]=(0,s.useState)(!1);return(0,a.jsxs)("div",{children:[(0,a.jsxs)("div",{class:"generatortitle",children:[a.jsx("h1",{children:"Prompt Generator"}),a.jsx("p",{children:"Generate a prompt for AI to grade."})]}),(0,a.jsxs)("div",{class:"body",children:[a.jsx("div",{class:"description",children:a.jsx("label",{for:"subject",children:"Pick a subject and FRQ type to get a question you can practice with!"})}),(0,a.jsxs)("div",{class:"options",children:[(0,a.jsxs)("div",{class:"apWorld",children:[a.jsx("label",{for:"apWorld",children:"AP World History"}),(0,a.jsxs)("div",{class:"buttons",children:[a.jsx("button",{className:"subjectButton",onClick:()=>{n("worldLEQ"),d("worldLEQinst"),m(!0)},children:"LEQ"}),a.jsx("button",{className:"subjectButton",onClick:()=>{n("worldSAQ"),d("worldSAQinst"),m(!0)},children:"SAQ"})]})]}),(0,a.jsxs)("div",{class:"apUSH",children:[a.jsx("label",{for:"apUSH",children:"AP US History"}),(0,a.jsxs)("div",{class:"buttons",children:[a.jsx("button",{className:"subjectButton",onClick:()=>{n("apushLEQ"),d("apushLEQinst"),m(!0)},children:"LEQ"}),a.jsx("button",{className:"subjectButton",onClick:()=>{n("apushSAQ"),d("apushSAQinst"),m(!0)},children:"SAQ"})]})]}),(0,a.jsxs)("div",{class:"apEuro",children:[a.jsx("label",{for:"apEuro",children:"AP EU History"}),(0,a.jsxs)("div",{class:"buttons",children:[a.jsx("button",{className:"subjectButton",onClick:()=>{n("euroLEQ"),d("euroLEQinst"),m(!0)},children:"LEQ"}),a.jsx("button",{className:"subjectButton",onClick:()=>{n("euroSAQ"),d("euroSAQinst"),m(!0)},children:"SAQ"})]})]}),(0,a.jsxs)("div",{class:"apLang",children:[a.jsx("label",{for:"apLang",children:"AP English Lang"}),a.jsx("div",{class:"buttons",children:a.jsx("button",{className:"subjectButton",onClick:()=>{n("argument"),d("argumentInst"),m(!0)},children:"Argument Essay"})})]})]}),a.jsx("div",{class:"generateButton",children:a.jsx("button",{class:"generateBtn",onClick:()=>{h()},children:"Generate Prompt"})}),(0,a.jsxs)("div",{class:"textSection",children:[!u&&a.jsx("p",{children:"Please select an FRQ type first."}),a.jsx("div",{class:"text-section",children:""===e?a.jsx("p",{children:"Your prompt will appear here"}):a.jsx("pre",{children:e})})]})]})]})};n()}catch(e){n(e)}})},9413:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>a});var n=o(997);function a({Component:e,pageProps:t}){return n.jsx(e,{...t})}o(2174),o(7200),o(3932),o(4992),o(6632),o(8187),o(6449)},2174:()=>{},8187:()=>{},3932:()=>{},4992:()=>{},6449:()=>{},7200:()=>{},6632:()=>{},5244:(e,t)=>{"use strict";var o;Object.defineProperty(t,"x",{enumerable:!0,get:function(){return o}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(o||(o={}))},2785:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/pages.runtime.prod.js")},6689:e=>{"use strict";e.exports=require("react")},997:e=>{"use strict";e.exports=require("react/jsx-runtime")},9648:e=>{"use strict";e.exports=import("axios")},1017:e=>{"use strict";e.exports=require("path")}};var t=require("../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),n=t.X(0,[899],()=>o(5395));module.exports=n})();